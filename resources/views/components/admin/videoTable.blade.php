                    ...
                    <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                        <div class="flex flex-row justify-center items-center gap-3">
                            <a href="">
                                ...
                                <div class="text-sm">
                                    <a href="{{route('admin.show',$video->slug)}}"><div class="font-semibold text-white">{{ $video->title }}</div></a>
                                    {{-- <a href="#"><div class="font-semibold text-white">{{ $video->title }}</div></a> --}}
...
<td class="px-6 py-4">
    <div class="flex justify-end gap-4">
                  ...
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="p-6 text-center">
                          ...
                          <div class="flex justify-center items-center">
                              ...
                              <form action="{{ route('admin.video.destroy', $video->slug) }}" method="POST">
                                @csrf
                                @method('DELETE')
        ...
        <a x-data="{ tooltip: 'Edite' }" href="{{ route('admin.video.edit', $video->slug) }}">

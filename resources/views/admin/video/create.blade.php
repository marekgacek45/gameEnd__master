...
<x-layouts.admin>
    <main >
        <div >
            <h2 class="text-center uppercase font-bold text-2xl mb-8">Stwórz Nowy Kafelek Video</h2>
            ...
            <form action="{{ route('admin.video.create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-6 gap-4">
                    ...
                    <div class="xl:col-span-4 p-8 bg-primaryColor rounded-md w-full">
                        <x-form.input name="title" namePl="Tytuł Video" class=" w-full xl:w-3/4"
                            placeholder="Wprowadź tytuł" />
                        <x-form.input name="link" namePl="Link YouTube" class=" w-full xl:w-3/4"
                            placeholder="Wprowadź link YouTUbe" />
